...
A continuación se muestra como hace la instalación el 3 sistemas operativos distintos.

<!--Hablar de XAMPP y las nuevas alternativas -->

------

### Práctica 00

Para realizar la configuración del ambiente de trabajo y sus herramientas utilice  el manual de acuerdo a su sistema operativo.

* GNU/Linux
  * [Instalación de laravel en distribuciones basadas en ArchiLinux](practicas/practica-00/laravel-en-linux-arch.md)
  * Instalación de laravel en distribuciones basadas en Ubuntu
* MacOS
* Windows
...
Para crear un proyecto de laravel utilizaremos las herramientas instaladas previamiente, en caso de no tenerlas instaladas revisar la [parte-00](parte-00.md) de este curso.
