...
<!--**Nota: Esta sección y las posteriores se complementarán con ejercicios. La teoría será mínima y de la lista de proyectos para acompañar la teoría se puede elegir el que desee para acompañar la teoría ** -->
...
* En donde  el método puede ser cualquier de los siguientes
  ...
  * DELETE
  ...
  <!-- Narrar ejemplos de los métodos de arriba -->
